...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      let picArr = [
        '../images/picImg/pic1.png',
        '../images/picImg/pic2.png',
        '../images/picImg/pic3.png',
        '../images/picImg/pic4.png',
        '../images/picImg/pic5.png',
        '../images/picImg/pic6.png',
        '../images/picImg/pic7.png',
        '../images/picImg/pic8.png',
      ]
